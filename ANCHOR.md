...
> 最后更新：2026-08-04（①②已落地并真机复测通过；v1.3.1 补苹果二级降级、v1.3.2 滑块上限 FPS 30/单帧 1200、v1.4.0 滑块上限 FPS 50/单帧 1300 + 接收完成提示音；**已开源 <https://github.com/viola0723/qr-airbridge>**；下一步 = 远期 #4 工装 / #5 光学时序 / #6 彩色网格）
...
- 无头验证：node 引擎回环 10 断言全绿（1300B 上限帧 20KB 随机数据 L=17 字节一致 + SHA 通过 +
  ...
  **真机复测待补**：iPhone 50FPS/1300B 寻优 + 提示音出声确认。
